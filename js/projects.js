...
const projectsData = [
  {
    Name: 'Junior Scientica',
    Repo: 'https://github.com/the-cross-art/JSQuiz-mongoDB',
    Owner: 'Imran Nazir',
    profiles: [
      {
        github: 'https://github.com/the-cross-art/',
        linkedin: 'https://www.linkedin.com/in/imran-nazir-692abb112/',
      }
    ],
    Description: ` This is a full-stack website that I made along with my colleague . Its an online test taking system made for students during COVID-19 pandemic.The Website was used by more than 𝟑𝟓𝟎𝟎 𝐒𝐭𝐮𝐝𝐞𝐧𝐭𝐬, (𝟏𝟑+ 𝐒𝐜𝐡𝐨𝐨𝐥𝐬) to conduct the their competetive examniations. `,
    TechStack: ["AWS", "JS", "HTML", "CSS"]
  },

  {
    Name: 'Virtual Science & technology fair',
    ...
    Description: `Built the Official Website for the National Hackathon ( Virtual Science & technology fair ) of MODEL CLUB B.I.T Sindri.I received a Letter of Appreciation as a Web Developer from the respected Chairman of Model Club , Milan Kashyap, for my contribution towards the Club as a Web Developer during the academic session 2020 - 2021.`,
    TechStack: ["JavaScript", "HTML", "CSS", "Ruby"]
  },

  {
    ...
    Description: `The whole procedure of complaining about a particular issue and then resolution of the same by the Municipality is quite hectic and complex. In order to speed up this process and make things transparent we have developed our Web Application Muni-Tech.`,
...

  {
    ...
    Description: `De'Vision is an event page with an opportunity to render your artistic vision to the world`,
...

  {
    ...
    Description: `My first full-stack website using RestFul APIS and database. The website let you book you fav camping place through online medium. `,
